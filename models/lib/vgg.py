...
from models.lib.convs import ConvBNReLU
import config as config


# ----- Description ---- #
# This is the class of vgg backbone which is used in segmentation feature extractor.
...
if __name__ == '__main__':
    ...
    model = vgg16(pretrained=config.PRETRAIN_VGG, input_features=False)
    model = model
    for i in range(5):
